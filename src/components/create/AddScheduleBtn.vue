<template>
    <button class="btn mt-05" @click="showModal = true">
        <i class="bi bi-plus"></i> Customize Schedule
    </button>
...
export default {
    ...
    methods: {
        handleClick(){
            ...
            this.schedule = {...defaltSchedule}
            this.weekDays = JSON.parse(JSON.stringify(weekDays))
